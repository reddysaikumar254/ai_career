...
function AiTools() {
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12 space-y-8 sm:space-y-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-neutral-200 dark:bg-neutral-800 flex items-center justify-center">
              <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-neutral-700 dark:text-neutral-300" />
            </div>
